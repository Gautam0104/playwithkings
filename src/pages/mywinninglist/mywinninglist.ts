...
/**
 * Generated class for the MywinninglistPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-mywinninglist',
  templateUrl: 'mywinninglist.html',
})
export class MywinninglistPage {
  houses:any={};
  user_info:any={};
  coursed:any=[];
  ...
  let data ={user_id:this.user_info.user_id,house:this.houses.mf_id};
    this.services.commonfunction(data,'dashboard/mybettlist').then((result: any) => {
