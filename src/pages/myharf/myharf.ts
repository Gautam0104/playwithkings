...
/**
 * Generated class for the MyharfPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-myharf',
  templateUrl: 'myharf.html',
})
export class MyharfPage {
  ...
  let data ={user_id:this.user_info.user_id};
    this.services.commonfunction(data,'dashboard/getharfbet').then((result: any) => {
